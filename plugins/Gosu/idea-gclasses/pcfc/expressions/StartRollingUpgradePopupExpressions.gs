...
class StartRollingUpgradePopupExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends StartRollingUpgradeScreenExpressionsImpl {
    ...
    // 'value' attribute on CheckBoxCell (id=Checked_Cell) at StartRollingUpgradePopup.pcf: line 58, column 43
    ...
    // 'value' attribute on TextCell (id=condition_Cell) at StartRollingUpgradePopup.pcf: line 64, column 30
  ...
  public static class StartRollingUpgradeScreenExpressionsImpl extends StartRollingUpgradePopupExpressionsImpl {
    ...
    // 'action' attribute on Link (id=RecommendGoTo) at StartRollingUpgradePopup.pcf: line 33, column 126
    function action_1 () : void {
      CurrentLocation.cancel(); DatabaseTableInfo.go()
    }
    
    // 'action' attribute on ToolbarButton (id=StartRolling) at StartRollingUpgradePopup.pcf: line 80, column 93
    function action_11 () : void {
      Page.startRollingUpgrade(); CurrentLocation.commit()
    }
    
    // 'available' attribute on ToolbarButton (id=StartRolling) at StartRollingUpgradePopup.pcf: line 80, column 93
    ...
    // EditButtons (id=editButtons) at StartRollingUpgradePopup.pcf: line 85, column 36
    function label_12 () : java.lang.Object {
      return gw.api.util.LocationUtil.hasOwnBundle(CurrentLocation) ? DisplayKey.get("Button.Update") : DisplayKey.get("Button.OK")
    }
    
    // 'value' attribute on RowIterator (id=iterator) at StartRollingUpgradePopup.pcf: line 53, column 55

...
import { GwAjaxResponseStatus, GwMap, GwResponseErrorHandleResult } from "../../types/gwTypes";
import ErrorTextStatus = JQuery.Ajax.ErrorTextStatus;
export declare type SuccessCallback = (response: any) => void;
export declare type ErrorCallback = (request: JQueryXHR, response: any, errorType: GwAjaxResponseStatus, httpErrorString: string | null) => GwResponseErrorHandleResult | void;

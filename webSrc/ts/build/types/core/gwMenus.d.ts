 ...
 * @type {{}}
 */
import { GwClassIdTagOrNode, GwDomNode, GwMap, GwEventType } from "../types/gwTypes";
import { GwInitializableSystem } from "./util/GwInitializableSystem";
export declare class GwMenus extends GwInitializableSystem {
     ...
     * @param node
     */
    openSubMenuMouseEnter(node: GwDomNode): void;
     ...
     * @returns {null}
     */
    openSubMenu(classIdTagOrNode: GwClassIdTagOrNode, eventType?: string): void;
    /**
     ...
     */
    closeSubMenu(classIdTagOrNode: GwClassIdTagOrNode): void;
    /**
     * @public

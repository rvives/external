...
class PickProfilerSourceLV_WebServiceExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends PickProfilerSourceLVExpressionsImpl {
    ...
    // 'value' attribute on DateCell (id=StartDate_Cell) at PickProfilerSourceLV.WebService.pcf: line 55, column 46
    function value_15 () : java.util.Date {
      return soapCallHistory.StartDate
    }
    
    // 'value' attribute on DateCell (id=CompleteDate_Cell) at PickProfilerSourceLV.WebService.pcf: line 61, column 49

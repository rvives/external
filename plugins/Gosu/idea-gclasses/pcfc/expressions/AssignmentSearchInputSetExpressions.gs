...
class AssignmentSearchInputSetExpressions {
  ...
  public static class AssignmentSearchInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Username_Input) at AssignmentSearchInputSet.pcf: line 31, column 55
    function defaultSetter_12 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.UserCriteria.Username = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=GroupCriteriaName_Input) at AssignmentSearchInputSet.pcf: line 42, column 56
    function defaultSetter_24 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.GroupCriteria.GroupName = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on RangeInput (id=SearchFor_Input) at AssignmentSearchInputSet.pcf: line 22, column 48
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.SearchType = (__VALUE_TO_SET as typekey.AssignmentSearchType)
    }
    
    // 'value' attribute on TextInput (id=GroupCriteriaNameKanji_Input) at AssignmentSearchInputSet.pcf: line 48, column 124
    function defaultSetter_31 (__VALUE_TO_SET :  java.lang.Object) : void {
      (searchCriteria.GroupCriteria as GroupSearchCriteria).GroupNameKanji = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=GroupName_Input) at AssignmentSearchInputSet.pcf: line 54, column 56
    function defaultSetter_38 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.QueueCriteria.QueueGroupName = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=GroupNameKanji_Input) at AssignmentSearchInputSet.pcf: line 60, column 124
    function defaultSetter_45 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.QueueCriteria.QueueGroupNameKanji = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=QueueName_Input) at AssignmentSearchInputSet.pcf: line 66, column 56
    function defaultSetter_51 (__VALUE_TO_SET :  java.lang.Object) : void {
      searchCriteria.QueueCriteria.QueueName = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'editable' attribute on RangeInput (id=SearchFor_Input) at AssignmentSearchInputSet.pcf: line 22, column 48
    function editable_1 () : java.lang.Boolean {
      return assignmentSearchTypes.length > 1
    }
    
    // 'label' attribute on TextInput (id=GroupCriteriaName_Input) at AssignmentSearchInputSet.pcf: line 42, column 56
    ...
    // 'label' attribute on TextInput (id=GroupName_Input) at AssignmentSearchInputSet.pcf: line 54, column 56
    ...
    // 'valueRange' attribute on RangeInput (id=SearchFor_Input) at AssignmentSearchInputSet.pcf: line 22, column 48
    ...
    // 'visible' attribute on TextInput (id=Username_Input) at AssignmentSearchInputSet.pcf: line 31, column 55
    function visible_10 () : java.lang.Boolean {
      return searchCriteria.SearchType == TC_USER
    }
    
    // 'visible' attribute on TextInput (id=GroupCriteriaName_Input) at AssignmentSearchInputSet.pcf: line 42, column 56
    function visible_21 () : java.lang.Boolean {
      return searchCriteria.SearchType == TC_GROUP
    }
    
    // 'visible' attribute on TextInput (id=GroupCriteriaNameKanji_Input) at AssignmentSearchInputSet.pcf: line 48, column 124
    function visible_29 () : java.lang.Boolean {
      return searchCriteria.SearchType == TC_GROUP and gw.api.util.LocaleUtil.CurrentLocaleType == LocaleType.TC_JA_JP
    }
    
    // 'visible' attribute on TextInput (id=GroupName_Input) at AssignmentSearchInputSet.pcf: line 54, column 56
    function visible_35 () : java.lang.Boolean {
      return searchCriteria.SearchType == TC_QUEUE
    }
    
    // 'visible' attribute on TextInput (id=GroupNameKanji_Input) at AssignmentSearchInputSet.pcf: line 60, column 124
